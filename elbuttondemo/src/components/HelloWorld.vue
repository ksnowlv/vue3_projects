<template>
  ...
  <div class="flex justify-space-between mb-4 flex-wrap gap-4">
    <el-button v-for="button in linkButtons" :key="button.text" :type="button.type" link>{{ button.text }}</el-button>
  </div>

  <p>Disabled link button</p>
  <div class="flex justify-space-between flex-wrap gap-4">
    <el-button v-for="button in linkButtons" :key="button.text" :type="button.type" link disabled>{{ button.text
    }}</el-button>
  </div>
  ...
  <div class="flex justify-space-between mb-4 flex-wrap gap-4">
    <el-button v-for="button in textButtons" :key="button.text" :type="button.type" text>{{ button.text }}</el-button>
  </div>

  <p>Background color always on</p>
  <div class="flex justify-space-between mb-4 flex-wrap gap-4">
    <el-button v-for="button in textButtons" :key="button.text" :type="button.type" text bg>{{ button.text }}</el-button>
  </div>

  <p>Disabled text button</p>
  <div class="flex justify-space-between flex-wrap gap-4">
    <el-button v-for="button in textButtons" :key="button.text" :type="button.type" text disabled>{{ button.text
    }}</el-button>
  </div>
...
import { Search, Edit, Check, Message, Star, Delete, Share, ArrowLeft, ArrowRight, Upload } from '@element-plus/icons-vue'
